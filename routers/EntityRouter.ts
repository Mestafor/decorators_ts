...
export class EntityRouter<T extends BaseEntity> {
    ...
    @auth('reader')
    @logRoute
    public fetchAllEntity(req: Request, res: Response) {
    ...
    @auth('reader')
    @logRoute
    public fetchEntity(req: Request, res: Response) {
    ...
    public createEntity(req: Request, res: Response) {
        ...
        (newEntity as any)[idProperty] = uuid.v4();
        db.push(`/${this.name}/${(newEntity as any)[idProperty]}`, newEntity.getPersistenceObject());
    ...
    public updateEntity(req: Request, res: Response) {
        ...
        for(const propKey of propKeys) {
            (updatedObj as any)[propKey] = updatedData[propKey];
        }
